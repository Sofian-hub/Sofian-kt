...
const questionnaire = [
    {
        qlabel: "Combien de trophé(s) a Neymar avec l'équipe du Brésil ?",
        qid: 1,
        reponses: [
            { rlabel: "4", rid: 1 },
            { rlabel: "2", rid: 2 },
    ...
    {
        qlabel: "Quel est le premier club où il a joué ?",
        qid: 3,
        reponses: [
    ...
    {
        qlabel: "Quelle est la nationalité de Neymar JR ?",
        qid: 4,
        reponses: [
...
function verifierReponses() {
    ...
    if (reponses === bonnesReponses) {
        ...
        retryButton.onclick = recommencer; // Lier la fonction pour recommencer
        resultEl.appendChild(retryButton); // Ajout du bouton dans la section des résultats
    }
}
